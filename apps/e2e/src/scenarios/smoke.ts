 ...
 *
 * Цены берутся живыми (ctx.offset): диапазон входа обязан быть в пределах гейта slippage
 * (MAX_ENTRY_SLIPPAGE_PCT=0.5%), иначе вход штатно уходит в skipped(price_slippage).
 */
