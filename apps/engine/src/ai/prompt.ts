...
AN UNCHANGED ORDER IS NOT AN ACTION. "лимитка остаётся так же", "остальные лимитки актуальны", "стоп прежний" only CONFIRM what already stands: emit nothing for them. Never emit an open/add whose price you cannot fill in — an action with entry.mode="price" and price=null is not an instruction, it is a statement about an order that already exists.
